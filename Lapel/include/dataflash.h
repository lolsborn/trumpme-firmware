...
#define _SST25VF040B_

#if defined(_SST25VF040B_)
#define WORD_WRITE 1
#define END_ADDRESS 0x7FFFF
#elif defined(_SST25VF010A_)
#define WORD_WRITE 0
#define END_ADDRESS 0x1FFFF
#elif defined(_SST25VF080B_)
#define WORD_WRITE 1
#define END_ADDRESS 0xFFFFF
#endif

#define DF_PORT PORTA
#define SI PIN1_bm      // SLAVE PIN 5, YELLOW
#define SO PIN2_bm      // SLAVE PIN 2, GREEN
#define SCK PIN3_bm     // SLAVE PIN 6, BLUE
#define CE PIN4_bm     // SlAVE PIN 1, ORANGE 
...
#else
#define OP_AAI_WORD_PROG 0xAF /* Auto Address Increment Programming */
...
#define FIRST_50K 0x0C800
#define FIRST_100K 0x19000
